...
<section id="section-font">
    <div class="row">
        ...
        <div class="col-md-6 text-center"><h2 class="Welcome">独立账户注册</h2></div>
        <div class="col-md-3"></div>
    </div>
</section>
...
<section id="section-companyRegister">
    <form id="companyRegisterForm"   action="${pageContext.request.contextPath}/Register/registerIndependentUser" method="post" >
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-4"></div>
                <div class="col-md-1"><span>电话:</span></div>
                <div class="col-md-4">
