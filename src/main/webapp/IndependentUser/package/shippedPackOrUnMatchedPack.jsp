...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#shippedPackOrUnMatchedPack-table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#shippedPackOrUnMatchedPack-table').bootstrapTable({//表格初始化
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="shippedPackOrUnMatchedPack-table">
                        </table>
                    </div>
