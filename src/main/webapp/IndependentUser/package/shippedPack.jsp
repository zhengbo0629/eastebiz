...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#shippedPack-table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#shippedPack-table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/packageList/queryShippedPackage",
        ...
        function AddFunctionAlty(value,row,index) {
            return['<button id="update-button" type="button"  onclick="update('+row.id+')" class="btn btn-default-update">Update</button>'].join("")
        }
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="shippedPack-table">
                        </table>
                    </div>
            ...
            <div class="col-md-2 text-left"  style="background-color: #aeffc8">
                ...
                <div id="wrapperSideBar">
                    ...
                    <div class="col-md-12"><a class="mobile-link" href='${pageContext.request.contextPath}/user/unMatchPac.jsp'>不匹配包裹</a></div>
