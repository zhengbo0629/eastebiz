...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#allUnCheckedPackForCompany-table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#allUnCheckedPackForCompany-table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/packageList/queryAllUnCheckPackage",
        ...
        function AddFunctionAlty(value,row,index) {
            return['<button id="update-button" type="button"  onclick="update('+row.id+')" class="btn btn-default-update">领取任务</button>'].join("")
        }
        ...
        function update(id) {
            $.ajax({
                type:"post",
                async:false,
                url:"${pageContext.request.contextPath}/packageList/updateCheckingStatusPackage",
                data:"ids="+id,
                success:function () {
                    location.href="${pageContext.request.contextPath}/package/allUnCheckedPackForCompany.jsp";
                }
            })
        }
        ...
        //复选
                ...
                function checkbox() {
                    var newid = $("#allUnCheckedPackForCompany-table").bootstrapTable('getSelections');
        ...
        <div class="row">
            <div class="col-md-10 ">
                <div class="col-md-12 text-center">
                    <h3>所有未对单包裹(All UnCheck Packages)</h3>
                </div>
                <%-- 按钮  --%>
                <div class="row">
                    <div class="col-md-6"><a class="btn btn-default" style="background-color: #aeffc8" onclick="checkbox()" href="#" role="button">批量领取任务</a></div>
                    <div class="col-md-6 text-right">
                        <a class="btn btn-default" style="background-color: #aeffc8" href="${pageContext.request.contextPath}/IndependentUser/package/allCurrentCheckingTasksForUser.jsp" role="button">已领取任务</a>
                        <a class="btn btn-default" style="background-color: #aeffc8" href="${pageContext.request.contextPath}/IndependentUser/package/allCheckedPackForUser.jsp" role="button">已完成任务</a>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="allUnCheckedPackForCompany-table">
                        </table>
                    </div>
