...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#unMatchPac-table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#unMatchPac-table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/packageList/queryUnMatchPackage",
        ...
        <div class="row">
            <div class="col-md-10 ">
                <div class="col-md-12 text-center">
                    <h3>不匹配包裹(UnMatch Package)</h3>
                </div>
                <div class="row">

                    <%--  <div class="col-md-1"></div>--%>
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="unMatchPac-table">
                        </table>
                    </div>
