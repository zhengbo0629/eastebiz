...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#queryReportPackage-Table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#queryReportPackage-Table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/Product/queryAllPurchaseProduct",
                height:600,
                method: 'post',
                pageSize: 2,
                pageNumber: 1,
        ...
        function AddFunctionAlty(value,row,index) {
            return['<button id="update-button" type="button"  onclick="reportPackage('+row.id+')" class="btn btn-default-update">领票</button>'].join("")
        }

        function reportPackage(id) {
           $.ajax({
               type:"post",
               async:false,
               url:"${pageContext.request.contextPath}/Product/queryReportPackage",
               data:"id="+id,
               success:function () {
                   location.href="reportPackage.jsp";
               }
           })
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="queryReportPackage-Table">
                        </table>
                    </div>
