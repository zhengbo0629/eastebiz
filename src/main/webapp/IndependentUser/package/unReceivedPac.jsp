...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#unReceivedPac-table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#unReceivedPac-table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/packageList/queryUnTrackPackage",
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="unReceivedPac-table">
                        </table>
                    </div>
