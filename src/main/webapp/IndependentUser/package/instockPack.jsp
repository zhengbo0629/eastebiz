...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#instockPack-table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#instockPack-table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/packageList/queryInstockPackage",
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="instockPack-table">
                        </table>
                    </div>
