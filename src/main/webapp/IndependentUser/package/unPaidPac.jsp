...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#unPaidPac-table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#unPaidPac-table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/packageList/queryUnPaiedPackage",
    ...
    <div class="menu-div">
        <div class="row">
            <div class="col-md-10 ">
                ...
                <%-- 按钮  --%>
                <div class="row">
                    <div class="col-md-6"><a class="btn btn-default" style="background-color: #aeffc8" href="#" role="button">批量更新</a></div>
                    <div class="col-md-6 text-right">
                      </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="unPaidPac-table">
                        </table>
                    </div>
