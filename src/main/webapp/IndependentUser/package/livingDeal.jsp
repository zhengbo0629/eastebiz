    ...
    <script type="text/javascript">
        ...
        $(function () {
            var tableColumns = [
                ...
                {field: '', title: '收购价格/Buy Pri0ce'},
                {field: '', title: '领票/Get Tickets'},
                {field: '', title: '查看网页/Get Tickets'},
            ...
            $('#livingDeal-table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#livingDeal-table').bootstrapTable({//表格初始化
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="livingDeal-table">
                        </table>
                    </div>
