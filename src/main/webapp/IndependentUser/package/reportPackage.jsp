...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#Package-packageQuantity").blur(function () {
                var a = $("#Package-limitPerPerson").val();
                var b = $("#Package-packageQuantity").val();
                if(parseInt(b)>parseInt(a)){
                    $("#Package-Quantity").text("不能比Limit大！");
                    $("#Package-packageQuantity").val("");
                }else{
            ...
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <a class="btn btn-default" style="background-color: #aeffc8" href="${pageContext.request.contextPath}/IndependentUser/package/queryReportPackage.jsp" role="button">所有票管理</a>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 ">
                        ...
                        <form id="userloginForm" action="${pageContext.request.contextPath}/IndependentUser/package/reportPackage.jsp" method="post" >
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" id="Package-model" name="model" placeholder="Model"  readonly value="${sessionScope.newProduct.model}" autofocus required>
                                        </div>

                                        <div class="col-md-2"><span>Brand:</span></div>
                                        <div class="col-md-4">
                                            <input type="text" id="Package-brand" class="form-control" name="brand" placeholder="Brand"  readonly value="${sessionScope.newProduct.brand}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    Product Name:
                                    <div class="col-md-12">
                                        <input type="text" id="Package-productName" class="form-control" name="productName" placeholder="ProductName" readonly value="${sessionScope.newProduct.productName}" autofocus required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-1"><span>填写数量:</span></div>
                                    <div class="col-md-2">
                                        <input type="text" id="Package-packageQuantity"   class="form-control" name="packageQuantity" placeholder="0">
                                    </div>
                                    <div class="col-md-1"><font color="#ff3b25"><span id="Package-Quantity"></span></font></div>
                                    <div class="col-md-1"><span>Limit:</span></div>
                                    <div class="col-md-2">
                                        <input type="text" id="Package-limitPerPerson" class="form-control"  readonly value="${sessionScope.newProduct.limitPerPerson}">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-2">
                                        <input type="text" id="Package-addressStatus" class="form-control"  <%--hidden --%>name="addressStatus">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                   <div class="col-md-2"><span>地址:</span></div>
                                    <div class="col-md-10">
                                        <input type="text" id="Package-shippingAddress" class="form-control" readonly name="shippingAddress"   placeholder="Address">
                                    </div>
                                </div>
                            </div>
