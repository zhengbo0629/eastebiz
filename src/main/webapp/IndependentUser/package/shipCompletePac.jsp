...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#shipCompletePac-table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#shipCompletePac-table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/packageList/queryShippedCompletePackage",
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="shipCompletePac-table">
                        </table>
                    </div>
            ...
            <div class="col-md-2 text-left"  style="background-color: #aeffc8">
                ...
                <div id="wrapperSideBar">
                    ...
                    ${pageContext.request.contextPath}/company/companyAccountSetting.jspcompanyAccountSetting.jsp'>公司账户管理</a></div>
