    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#queryReportPackage-Table').bootstrapTable({//表格初始化
                ...
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/Product/seclectAllEbizcompanyId",
                /* width:1000,*/
                height:600,
                method: 'get',
                pageSize: 2,
        ...
        function AddFunctionAlty(value,row,index) {
            return['<button id="update-button" type="button"  onclick="reportPackage('+row.id+')" class="btn btn-default-update">求购/议价</button>'].join("")
        }
