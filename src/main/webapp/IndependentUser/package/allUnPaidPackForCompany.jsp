    ...
    <script type="text/javascript">
        ...
        $(function () {
            var tableColumns = [
                ...
                {field: 'creditCardNumber', title: '信用卡'},
            ...
            $('#allUnPaidPackForCompany-table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#allUnPaidPackForCompany-table').bootstrapTable({//表格初始化
    ...
    <div class="menu-div">
        <div class="row">
            <div class="col-md-10 ">
                ...
                <%-- 按钮  --%>
                <div class="row">
                    <div class="col-md-6"><a class="btn btn-default" style="background-color: #aeffc8" href="#" role="button">批量领取任务</a></div>
                    <div class="col-md-6 text-right">
                        <a class="btn btn-default" style="background-color: #aeffc8" href="${pageContext.request.contextPath}/IndependentUser/package/allCurrentPayingTasksForUser.jsp" role="button">已领取任务</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="allUnPaidPackForCompany-table">
                        </table>
                    </div>
            ...
            <div class="col-md-2 text-left"  style="background-color: #aeffc8">
                ...
                <div id="wrapperSideBar">
                    ...
                    <div class="col-md-12"><a class="mobile-link" href='${pageContext.request.contextPath}/'>查看所有用户</a></div>
                    <div class="col-md-12"><a class="mobile-link" href='${pageContext.request.contextPath}/'>添加新用户</a></div>
                    <%--<div class="col-md-12"><a class="mobile-link" href='${pageContext.request.contextPath}/user/addUnActive.jsp'>添加未激活</a></div>--%>
                    <div class="col-md-12"><a class="mobile-link" href='${pageContext.request.contextPath}/'>收到新请求</a></div>
                    ...
                    <div class="col-md-12"><a class="mobile-link" href='${pageContext.request.contextPath}/IndependentUser/package/querySellorobo.jsp'>Deal管理</a></div>
