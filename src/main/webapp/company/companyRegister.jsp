...
<section id="section-font">
    <div class="row">
        ...
        <div class="col-md-6 text-center"><h3 class="Welcome">主账户注册</h3></div>
        <div class="col-md-3"></div>
    </div>
</section>
...
<section id="section-companyRegister">
    <form id="companyRegisterForm"   action="${pageContext.request.contextPath}/Register/registerCompany" method="post" >
