                ...
                <div class="col-md-6 text-right">
                    <span>
                        ...
                        <div style="font-size: 12px;">
                             <a class="mobile-link" href="#" style=""> 欢迎您！
            ...
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 ">
                        ...
                        <form id="userloginForm"   action="${pageContext.request.contextPath}/EbizStatus/updateEbizStatus" method="post" >

                            <div class="row">
                                <div class="form-group">
                                    <input input type="text" class="form-control" id="EbizStatus-id" name="id" value="${sessionScope.EbizStatus.id}" hidden>
                                    <div class="row">
                                        <div class="col-md-2"><span>用户ID:</span></div>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" id="EbizStatus-userId"   disabled value="${sessionScope.EbizStatus.userId}" >
                                        </div>

                                        <div class="col-md-2"><span>用户名:</span></div>
                                        <div class="col-md-4">
                                            <input type="text" id="EbizStatus-userName" class="form-control"  disabled value="${sessionScope.EbizStatus.ebizUser.userName}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control" name="status" id="EbizStatus-status" value="${sessionScope.EbizStatus.status}">
                                            <option selected="selected" value="${sessionScope.EbizStatus.status}">Please Chose</option>
                                            <option value="Active">Active</option>
                                            <option value="AddUnActive">AddUnActive</option>
                                        </select>
                                    </div>

                                    <div class="col-md-1"><span>诚信度:</span></div>
                                    <div class="col-md-3">
                                        <select class="form-control" name="starLevel" id="EbizStatus-starLevel">
                                            <option selected="selected" value="${sessionScope.EbizStatus.starLevel}">Please Chose</option>
                            ...
                            <%--<div class="form-group">
                                <div class="row">
                                    <div class="col-md-2"><span>限制购买数量:</span></div>
                                    <div class="col-md-2">
                                        <input type="text" id="EbizStatus-userPersonalLimit"   class="form-control" name="userPersonalLimit" placeholder="0">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-1"><span>备注:</span></div>
                                    <div class="col-md-11">
                                        <input type="text" id="EbizStatus-userMnote" class="form-control"  name="userMnote">
                                    </div>
                                </div>
                            </div>
