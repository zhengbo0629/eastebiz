...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            var tableColumns = [
                {field: 'id', title: 'ID'},
                {field: 'ebizUser.id', title: '用户ID'},
                {field: 'ebizUser.userName', title: '用户名字'},
                {field: 'status', title: '用户状态'},
                {field: 'starLevel', title: '诚信度'},
                {field: 'userMnote', title: '备注'},
            ...
            $('#queryAllUser-Table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#queryAllUser-Table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/EbizStatus/queryAllEbizUser",
                /* width:1000,*/
                height:600,
                method: 'get',
                pageSize: 2,
        ...
        function update(id){
            $.ajax({
                type:"post",
                url:"${pageContext.request.contextPath}/EbizStatus/queryOneEbizStatus",
                data:"id="+id,
                success:function () {
                    location.href="${pageContext.request.contextPath}/company/updateUser.jsp";
                }
            })
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="queryAllUser-Table">
                        </table>
                    </div>
