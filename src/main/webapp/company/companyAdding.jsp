...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#companyAdding-Table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#companyAdding-Table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/EbizRelationo/queryAllUserAndCompany",
                /* width:1000,*/
                height:600,
                method: 'get',
                pageSize: 2,
        ...
        function AddFunctionAlty(value,row,index) {
            return['<button id="agree-button" type="button"  onclick="agree('+row.id+')" class="btn btn-default-update">同意</button>',
                '<button id="Delete-button" type="button"  onclick="Delete('+row.id+')" class="btn btn-default-update">不同意</button>'].join("")
        }
        ...
        function agree(id){
            $.ajax({
                type:"post",
                url:"${pageContext.request.contextPath}/EbizStatus/companyAddUser",
                data:"id="+id,
                success:function () {
                    location.href="${pageContext.request.contextPath}/company/companyAdding.jsp";
                }
            })
        ...
        function Delete(id){
            $.ajax({
                type:"post",
                url:"${pageContext.request.contextPath}/EbizRelationo/updateEbizRelationoPerations",
                data:"id="+id,
                success:function () {
                    location.href="${pageContext.request.contextPath}/company/companyAdding.jsp";
                }
            ...
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a class="btn btn-default" style="background-color: #aeffc8" href="${pageContext.request.contextPath}/company/addUser.jsp" role="button">添加新用户</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="companyAdding-Table">
                        </table>
                    </div>
