...
<header id="header-main">
    <div class="main-topbar">
        <div class="container">
            <div class="row">
                <div class="col-md-2 "><a class="mobile-link" href="${pageContext.request.contextPath}/homepage/homepage.jsp"><h1 class="eastebiz">EastEbiz</h1></a></div>
                ...
                <div class="col-md-6 text-right">
                    <span>
                        ...
                        <div style="font-size: 12px;">
                            ...
                            <a class="mobile-link" href="logout.jsp" style="">退出</a> |
