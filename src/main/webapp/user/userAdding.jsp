    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#userMain-Table').bootstrapTable({//表格初始化
                ...
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/EbizRelationo/queryALLCompanyAndUser",
                /* width:1000,*/
                height:600,
                method: 'get',
                pageSize: 2,
        ...
        function agree(id){
            $.ajax({
                type:"post",
                url:"${pageContext.request.contextPath}/EbizStatus/userAddCompany",
                data:"id="+id,
                success:function () {
                    location.href="${pageContext.request.contextPath}/user/userMain.jsp";
                }
            })
        ...
        function Delete(id){
            $.ajax({
                ...
                data:"id="+id,
                success:function () {
                    location.href="${pageContext.request.contextPath}/user/userAdding.jsp";
                }
            })
        }
