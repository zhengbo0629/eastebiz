...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#addUnActive-Table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#addUnActive-Table').bootstrapTable({//表格初始化
        ...
        /*  function AddFunctionAlty(value,row,index) {
              return['<button id="update-button" type="button"  onclick="('+row.id+')" class="btn btn-default-update">操作</button>'].join("")
          }
  */
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="addUnActive-Table">
                        </table>
                    </div>
