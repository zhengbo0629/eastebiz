...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#activeAllProduct-Table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#activeAllProduct-Table').bootstrapTable({//表格初始化
                columns: tableColumns,  //表头
                //data: //通过ajax返回的数据
                url:"${pageContext.request.contextPath}/Product/queryAndStatus?status=Active",
                /* width:1000,*/
                height:600,
                method: 'get',
                pageSize: 2,
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="activeAllProduct-Table">
                        </table>
                    </div>
