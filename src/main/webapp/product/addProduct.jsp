                        ...
                        <form id="userloginForm"   action="${pageContext.request.contextPath}/Product/registerProductAndAmendbProduct" method="post" >
                          ...
                          <div class="row">
                              <div class="form-group">
                                  <input input type="text" class="form-control" id="Product-id" name="id"  hidden>
                                  <div class="row">
                                      <div class="col-md-1"><span>Model:</span></div>
                                      <div class="col-md-4">
                                          <input type="text" class="form-control" id="Product-model" name="model" placeholder="Model"  autofocus required>
                                      </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="Product-productName" class="form-control" name="productName" placeholder="ProductName"  autofocus required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" id="Product-brand" class="form-control" name="brand" placeholder="Brand" >
                                    </div>

                                    <div class="col-md-1"><span>SKU:</span></div>
                                    <div class="col-md-2">
                                        <input type="text" id="Product-sku" class="form-control" name="sku" placeholder="SKU" >
                                    </div>

                                    <div class="col-md-1"><span>UPC:</span></div>
                                    <div class="col-md-2">
                                        <input type="text" id="Product-upc" class="form-control" name="upc" placeholder="UPC" >
                                    </div>

                                    <div class="col-md-1"><span>ASIN:</span></div>
                                    <div class="col-md-2">
                                        <input type="text" id="Product-ASIN" class="form-control" name="asin" placeholder="ASIN" >
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-11">
                                        <input type="text" id="Product-URI" class="form-control" name="URI" placeholder="URI">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <input type="text" id="Product-tickets" class="form-control" name="tickets" placeholder="0" >
                                    </div>

                                    <div class="col-md-1"><span>Personal Limit: </span></div>
                                    <div class="col-md-1">
                                        <input type="text" id="Product-limitPerPerson" class="form-control" name="limitPerPerson" placeholder="0" >
                                    </div>

                                    <div class="col-md-1"><span>W(LB):</span></div>
                                    <div class="col-md-1">
                                        <input type="text" id="Product-weight" class="form-control" name="weight" placeholder="0.0" >
                                    </div>

                                    <div class="col-md-1"><span>L(inch):</span></div>
                                    <div class="col-md-1">
                                        <input type="text" id="Product-length" class="form-control" name="length" placeholder="0.0" >
                                    </div>

                                    <div class="col-md-1"><span>W(inch):</span></div>
                                    <div class="col-md-1">
                                        <input type="text" id="Product-width" class="form-control" name="width" placeholder="0.0" >
                                    </div>

                                    <div class="col-md-1"><span>H(inch):</span></div>
                                    <div class="col-md-1">
                                        <input type="text" id="Product-height" class="form-control" name="height" placeholder="0.0" >
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                价格:
                                            <input type="text" id="Product-homeBasePrice" class="form-control" name="homeBasePrice" placeholder="0.0" >
                                            </div>

                                            <div class="col-md-3">
                                                加价收购数量:
                                                <input type="text" id="Product-homePromotQuantity" class="form-control" name="homePromotQuantity" placeholder="0" >
                                            </div>

                                            <div class="col-md-3">

                                                加价收购价格:
                                                <input type="text" id="Product-homePromotPrice" class="form-control" name="homePromotPrice" placeholder="0.0" >
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                价格:
                                                <input type="text" id="Product-wareHouseBasePrice" class="form-control" name="wareHouseBasePrice" placeholder="0.0" >
                                            </div>

                                            <div class="col-md-3">
                                                加价收购数量:
                                                <input type="text" id="Product-wareHousePromotQuantity" class="form-control" name="wareHousePromotQuantity" placeholder="0" >
                                            </div>

                                            <div class="col-md-3">

                                                加价收购价格:
                                                <input type="text" id="Product-wareHousePromotPrice" class="form-control" name="wareHousePromotPrice" placeholder="0.0">
                                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    Note:
                                    <div class="col-md-12">
                                        <input type="text" id="Product-mnote" class="form-control" name="mnote"  placeholder="mnote">
                                    </div>
                                </div>
                            </div>
