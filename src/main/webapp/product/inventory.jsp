...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#inventory-Table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#inventory-Table').bootstrapTable({//表格初始化
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <table class="table  table-bordered table-striped table-bordered table-hover" id="inventory-Table">
                        </table>
                    </div>
