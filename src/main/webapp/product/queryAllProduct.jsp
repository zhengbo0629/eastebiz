...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#queryAllProduct-Table').bootstrapTable('destroy');   //动态加载表格之前，先销毁表格


            $('#queryAllProduct-Table').bootstrapTable({//表格初始化
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    ...
                    <form id="Form"   action="${pageContext.request.contextPath}/product/queryProduct.jsp" method="post" >
                ...
                <div class="row">
                  ...
                  <%--  <div class="col-md-1"></div>--%>
                    <div class="col-md-12 ">
                      <table class="table  table-bordered table-striped table-bordered table-hover" id="queryAllProduct-Table">
                        </table>
                    </div>
